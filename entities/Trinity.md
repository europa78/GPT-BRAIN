...
- Persistent scheduler/orchestrator above [[Antigravity]] pipelines.
- First workloads: this vault's nightly /compile, weekly /lint, weekly /synthesis (see README setup order).
- Related: [[Agent Loop Design]].
