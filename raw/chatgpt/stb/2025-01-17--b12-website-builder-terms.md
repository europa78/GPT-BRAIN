---
title: "B12 website builder terms"
date: 2025-01-17
...
# B12 website builder terms

> 4 messages · 2025-01-17 · cluster: STB / Marketing / Web

**Semantic neighbors:** [[BEE SEARCHABLE BUSINESS PLAN/website]] · [[Website Background Image Ideas]] · [[website re-write home page]] · [[Website Link Request]]

## Transcript

**Mike:** I am about to enter into an agreement for buying a subscription to a website.  my understanding is I pay $1 a month for 3 months and then pay $49 a month.  the terms also say I can cancel prior to the end of the 3 months and not be billed thereafter.   analyze the terms and conditions and highlight the section that stipulates this :   1. Business Information Collection
...
We optimize your GBP to enhance its search visibility:

Keyword Integration: We include targeted keywords in your business description and services to help you rank higher in local searches.
...
**GPT:** Below is an analysis of the terms and conditions you provided, along with an explanation of whether (and where) they reference the trial subscription pricing and the right to cancel:

---

## 1. **Analysis of Provided Terms**

You shared three sections:

1. **Business Information Collection**  
2. **Google Business Profile Setup**  
3. **Content Optimization**

None of these sections mentions **pricing**, **payment terms**, **refund/cancellation policies**, or any **trial period** arrangement. Specifically, the text does not state:

- **The $1/month for 3 months** arrangement.  
- **The subsequent $49/month** charge.  
- **Any provision allowing you to cancel before the end of the 3-month term** to avoid further billing.

In other words, **the sections you provided contain only service descriptions** (i.e., what the service includes, how they set up your Google Business Profile, and how they optimize content). They do not include any subscription or cancellation clause.

---

## 2. **Highlighting the Relevant “Stipulation”**

Because the text you provided makes **no mention** of the special pricing and cancellation terms, there is

**Mike:** Terms of Service
...
you may not, under any circumstances or for any reason, use the Services. B12 may, in
...
Services. Excluding Customer Content (as defined below and which shall be owned by
...
in violation of our guidelines and policies, including these Terms of Service.
...
providing the Services to you. You acknowledge and agree that (i) the quality of the
...
or resources on the Internet, and other websites, plug-ins, services or resources may
...
is 30 or more days past due may be terminated.
...
TERMINATE OR ALTER YOUR SUBSCRIPTION PLEASE CONTACT OUR
...
the transaction. Any agreement you have with your payment provider will govern your
...
systems or otherwise in our possession or control, unless legally prohibited. B12 reserves
...
LICENSED FOR USE IN HAZARDOUS ENVIRONMENTS REQUIRING FAILSAFE
...
INDIVIDUAL ARBITRATIONS. You also agree not to participate in claims brought in a
...
going forward. Your use of the Services is subject to the Terms of Service in effect at the
time of such use.
16. Miscellaneous.
...
any respect.
20. Notices.
Unless otherwise specified in these Term of Service, all notices under these Terms of
...
**GPT:** Below is an overview and analysis of the B12 Terms of Service you provided. We’ve focused specifically on identifying provisions related to subscription billing, automatic renewals, and cancellation—since your main concern is the arrangement of paying **\$1/month for 3 months** (the trial period) and then **\$49/month** thereafter, with the right to cancel before the end of the 3-month period.

---

## 1. **Do the Terms Mention \$1/month for 3 Months, Then \$49/month?**

No. The Terms of Service, as posted, do **not** reference a specific discounted trial of \$1/month for 3 months, nor do they set forth a switch to \$49/month. Those details are presumably part of a **separate offer** or **promotional plan** you’ve been provided outside of the standard TOS text.  

That said, the standard Terms **do** contemplate that (a) Services can have different pricing tiers or promotional rates; and (b) you can cancel a subscription. So your special \$1-for-3-months-then-\$49 plan likely falls under the general “Paid Services” rules in Section 7.

---

## 2. **Right to Cancel Before Being Charged Again**

The Terms do address cancellation in a few places. Below are the **key sections** to know:

1. **Section 7(e) – “Auto Renewal”**  
   - Explains that if you sign up for a subscription, it will **automatically** renew for successive periods at the **then-current** non-promotional rate unless you cancel or change your plan.  
   - This is why, once your \$1/month promotional period ends, you would automatically be charged the regular \$49/month—**unless** you’ve canceled beforehand.  

2. **Section 7(g) – “Cancelling or Changing Paid Services”**  
   - This is the crucial part covering how to **cancel** (or otherwise change) your subscription.  
   - States you can **“change or cancel your Paid Services at any time”** by contacting B12 (hello@b12.io).  
   - Emphasizes that any request for cancellation should be sent **at least ten (10) business days prior** to the end of the subscription term to ensure processing before you’re charged again.  
   - Says if you cancel in the middle of a subscription term, you generally can continue using the service for the remainder of that term, and then it will **not renew**. There are no **prorated refunds**.  

Because your arrangement presumably **renews** from the introductory 3-month price to the \$49/month, you want to **cancel at least 10 business days before** the first \$49 charge is scheduled if you do **not** want to continue.  

---

## 3. **Where Is the Cancellation Stipulation in the TOS?**

Even though the Terms do not mention “\$1 for 3 months” explicitly, the right to cancel before being billed again (thus preventing the \$49/month charge) is grounded in **Section 7(g) (“Cancelling or Changing Paid Services”)**. Below is the **relevant excerpt** quoted and emphasized:

> **7(g) Cancelling or Changing Paid Services.**  
> “To **change or cancel your Paid Services** at any time, contact B12 at hello@b12.io. **Any request for cancellation must be sent at least ten (10) business days prior** to the end of the Subscription term to allow for adequate processing time. Your nontermination or continued use of the relevant Paid Service reaffirms that B12 is authorized to charge your Payment Method the Fees for such Paid Service, including any associated fees… **If you terminate a Subscription, you may use the applicable Paid Service until the end of your then current Subscription term**; however, your Subscription… will not be renewed after your then current Subscription term expires. **You will not be eligible for a prorated refund** of any portion of any Fees paid…”

In other words, as soon as you see that your 3-month **introductory** period is about to end, you can **cancel** (by emailing B12 at least 10 business days in advance). This ensures you are **not** billed the regular \$49/month rate afterward.

---

## 4. **Summary**

- The **trial pricing** and subsequent **regular monthly pricing** you mentioned **do not** appear explicitly in these Terms. That arrangement likely comes from an additional promotional offer or service agreement (e.g., a marketing page, invoice, or custom plan you received).  
- The TOS **does** contain a **general cancellation policy** that applies to **all** subscription-based (auto-renewing) services, including promotional or discounted ones.  
- **Section 7(e)** explains **auto-renewals**; **Section 7(g)** describes **how to cancel**.  
- To avoid paying full price (\$49/month) after the 3-month period, you must **cancel** before the end of the promotional period—**typically at least 10 business days** in advance.

---

### **Key Takeaway**

> **Highlight:** The Terms do not expressly say “\$1 for 3 months, then \$49 thereafter.” However, **Section 7(e)** and **7(g)** are the stipulations that allow you to cancel your subscription in time to avoid the higher monthly rate. If you follow that procedure (i.e., cancel before the 3-month mark, per the instructions in Section 7(g)), you will **not** be billed beyond your trial.
